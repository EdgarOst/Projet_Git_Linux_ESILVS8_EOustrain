...
dfEURUSD = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixEURUSD.csv",sep=',',names=['Date','Valeur'])

dfEURY = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixYEN.csv",sep=',',names=['Date','Valeur'])

dfEURGBP = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixGBP.csv",sep=',',names=['Date','Valeur'])

dfEURUSD2 = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixUSD.csv",sep=',',names=['Date','Valeur'])
dfEURUSD2['Valeur'] = dfEURUSD2['Valeur'].apply(lambda x: str(x) + '$')

dfEURY2 = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixYEN.csv",sep=',',names=['Date','Valeur'])
dfEURY2['Valeur'] = dfEURY2['Valeur'].apply(lambda x: '¥' + str(x))

dfEURGBP2 = pd.read_csv("/home/ec2-user@ip-172-31-35-85/prixGBP.csv",sep=',',names=['Date','Valeur'])
